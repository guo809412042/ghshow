        ...
        <Collapse.Panel header="查询" key="1">
          <div style={{ width: '85%' }}>
            <div className={styles.formItem}>
              ...
              <Select className={`${styles.queryItem} ${styles.vipLabel}`} key="会员" value={isVip} onChange={setIsVip}>
                <Select.Option key="" value="">
                全部
                </Select.Option>
              ...
              <Select className={`${styles.queryItem} ${styles.versionLabel}`} key="版本" value={appVer} onChange={setAppVer}>
                <Select.Option key="" value="">
                所有版本
                </Select.Option>
