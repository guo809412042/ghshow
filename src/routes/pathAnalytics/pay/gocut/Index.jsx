 ...
 * @LastEditTime: 2020-09-29 17:34:38
 * @LastEditors: ssssslf
 */
...
import { payDetailGocutSQL, payGocutSQL, listSQL } from '../components/sqlTemplate';
...
export default () => {
  const [search, setSearch] = useState({
    where: ' and new_user =  \'N\'  and platform = \'1\'',
