...
export async function query(parmas) {
  const res = await xFetch(`${config.domainVcmGh}/api/app-developer/query?${qs.stringify(parmas)}`);
  // const res = await xFetch(`http://10.0.25.94:6090/api/app-developer/query?${qs.stringify(parmas)}`);
  return res;
}
...
export async function addEvent(option) {
  ...
  // const res = await xFetch('http://10.0.25.94:6090/api/event/add-event', {
    method: 'POST',
...
export async function updataEventModuleConfig(option) {
  ...
  // const res = await xFetch('http://10.0.25.94:6090/api/event/updata-event', {
    method: 'POST',
    body: JSON.stringify(option),
  });
  return res;
...
export async function deleteUser(id) {
  const res = await xFetch(`${config.domainVcmGh}/api/app-developer/delete/${id}`, {
  // const res = await xFetch(`http://10.0.25.94:6090/api/app-developer/delete/${id}`, {
    method: 'DELETE',
  });
  return res;
}
...
export async function create(option) {
  const res = await xFetch(`${config.domainVcmGh}/api/app-developer/create`, {
  // const res = await xFetch('http://10.0.25.94:6090/api/app-developer/create', {
    method: 'POST',
    body: JSON.stringify(option),
  });
  return res;
...
export async function removeCollectionEvent(option) {
  ...
  // const res = await xFetch('http://10.0.25.94:6090/api/event/remove-collection-event', {
    method: 'POST',
    body: JSON.stringify(option),
  });
  return res;
