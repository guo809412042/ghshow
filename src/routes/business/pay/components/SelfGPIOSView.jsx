...
import { gpIosColumns, gpIosColumns1 } from '../constSelf';
import {
  createSqlWhere, getNumber, dateFormat, getFixed,
} from '../../../../utils/utils';
import { iosGPDaySQL, iosGPMonthSQL } from './sqlTemplateSelf';
...
export default ({ search }) => {
  ...
  return <div>
    ...
    <DownLoadButton filename="GP/iOS销售指标-自有数据" columns={columns} data={dataSource} />
    <Table
      columns={columns}
